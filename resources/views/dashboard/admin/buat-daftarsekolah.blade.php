...
<h1 class="text-3xl font-bold bg-yellow-400 w-fit px-5 py-2  rounded-md shadow-md text-primary">TAMBAH DATA SEKOLAH</h1>
...
@endif
<form action="{{ route('daftarsekolah.store') }}" method="POST">
    ...
    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="col-span-full mt-10">
            ...
            <div class="mt-2">
            <input type="text" name="nama_sekolah" id="nama_sekolah" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Sekolah">
            </div>
        </div>
        <div class="col-span-full">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Deskripsi</label>
            <div class="mt-2">
            <textarea name="deskripsi" id="deskripsi" placeholder="Masukkan deskripsi singkat mengenai sekolah" cols="30" rows="10" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"></textarea>
            </div>
        </div>
        <div class="col-span-full mt-5">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Kepala Sekolah</label>
            <div class="mt-2">
            <input type="text" name="kepsek" id="kepsek" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Kepala Sekolah">
            </div>
        </div>
        </div>
        <div class="col-span-full mt-5">
            ...
            <div class="mt-2">
            <input type="text" name="operator" id="operator" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Operator">
            </div>
        </div>
        <div class="col-span-full mt-5">
        ...
        <div class="col-span-full mt-5">
            ...
            <div class="mt-2">
            <input type="text" name="kurikulum" id="kurikulum" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="mis. Kurikulum Merdeka">
            </div>
        </div>
        <div class="col-span-full mt-5">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Waktu</label>
            <div class="mt-2">
            <input type="text" name="waktu" id="waktu" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="mis. 08.00 s.d. 14.00">
            </div>
        </div>
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="npsn" id="npsn" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan NPSN">
                </div>
            </div>
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="sk_pendirian_sekolah" id="sk_pendirian_sekolah" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan SK Pendirian Sekolah">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Tanggal SK Pendirian</label>
                <div class="mt-2">
                <input type="text" name="tanggal_sk_pendirian" id="tanggal_sk_pendirian" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Tanggal SK Pendirian">
                </div>
            </div>
        </div>
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="sk_izin_operasional" id="sk_izin_operasional" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan SK Izin Operasional">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Tanggal SK Izin Operasional</label>
                <div class="mt-2">
                <input type="text" name="tanggal_sk_izin_operasional" id="tanggal_sk_izin_operasional" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Tanggal Sk Izin Operasional">
                </div>
            </div>
        </div>
        ...
        <div class="col-span-full mt-5">
            ...
            <div class="mt-2">
            <input type="text" name="kebutuhan_khusus_dilayani" id="kebutuhan_khusus_dilayani" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Kebutuhan Khusus Apa Saja yang Dilayani">
            </div>
        </div>
        <div class="col-span-full mt-5">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Nama Bank</label>
            <div class="mt-2">
            <input type="text" name="nama_bank" id="nama_bank" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Bank">
            </div>
        </div>
        <div class="col-span-full mt-5">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Cabang KCP/Unit</label>
            <div class="mt-2">
            <input type="text" name="cabang_kcpunit" id="cabang_kcpunit" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Cabang KCP/Unit">
            </div>
        </div>
        <div class="col-span-full mt-5">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Rekening Atas Nama</label>
            <div class="mt-2">
            <input type="text" name="rekening_atas_nama" id="rekening_atas_nama" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Pemilik Rekening">
            </div>
        </div>
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="sertifikasi_iso" id="sertifikasi_iso" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Sertifikat ISO">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Sumber Listrik</label>
                <div class="mt-2">
                <input type="text" name="sumber_listrik" id="sumber_listrik" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Sumber Listrik">
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="daya_listrik" id="daya_listrik" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Daya Listrik">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Kecepatan Internet</label>
                <div class="mt-2">
                <input type="text" name="kecepatan_internet" id="kecepatan_internet" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Kecepatan Internet">
                </div>
            </div>
        </div>
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="number" name="l_guru" id="l_guru" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Guru <span class="font-bold">(Perempuan)</span></label>
                <div class="mt-2">
                <input type="number" name="p_guru" id="p_guru" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="number" name="l_tendik" id="l_tendik" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="number" name="p_tendik" id="p_tendik" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="number" name="l_pd" id="l_pd" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="number" name="p_pd" id="p_pd" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
        </div>
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="number" name="ruang_tu_24" id="ruang_tu_24" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" min="0" required placeholder=0>
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Ruang Tata Usaha</label>
                <div class="mt-2">
                <input type="number" name="ruang_tu_25" id="ruang_tu_25" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" min="0" required placeholder=0>
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
        ...
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="alamat" id="alamat" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Alamat">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">RT/RW</label>
                <div class="mt-2">
                <input type="text" name="rt_rw" id="rt_rw" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan nomor RT/RW">
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="dusun" id="dusun" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Nama Dusun">
                </div>
            </div>
            <div class="w-full mt-5">
        ...
        <div class="flex space-x-5">
            ...
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="kode_pos" id="kode_pos" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Kode Pos">
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
            <div class="w-full mt-5">
                ...
                <div class="mt-2">
                <input type="text" name="lintang" id="lintang" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Garis Lintang">
                </div>
            </div>
            <div class="w-full mt-5">
                <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Bujur</label>
                <div class="mt-2">
                <input type="text" name="bujur" id="bujur" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan Garis Bujur">
                </div>
            </div>
        </div>
        <div class="flex space-x-5">
            <div class="w-full mt-5 ">
                ...
                <div class="mt-2">
                <input type="number" name="jumlah_kepadatan_penduduk" id="jumlah_kepadatan_penduduk" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required min="0" placeholder="0">
                </div>
            </div>
            <div class="w-full mt-5 ">
        ...
        <div class="col-span-full mt-5">
            ...
            <div class="mt-2">
            <input type="text" name="link_maps" id="link_maps" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan url Google Maps">
            </div>
        </div>
        <div class="col-span-full mt-5">
            <label for="pertemuan" class="block text-sm/6 font-medium text-gray-900">Link <span class="font-bold">Google Street View</span></label>
            <div class="mt-2">
            <input type="text" name="link_street_view" id="link_street_view" autocomplete="topik-pertemuan" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-md ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6" required placeholder="Masukkan url Google View">
            </div>
        </div>
        <div class="col-span-full mt-5">
              ...
              <div class="text-center">
                ...
                <div class="mt-4 flex text-sm/6 text-gray-600">
                  <label for="link_gambar" class="relative cursor-pointer rounded-md font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500 ">
                    ...
                    <input id="link_gambar" name="link_gambar" type="file" class="sr-only" accept=".jpg">
                  </label>
        ...
        <div class="mt-5">
            <button type="submit" class="bg-blue-500 text-white px-3 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-lg">+ Tambah Data Sekolah</button>
        </div>
    </div>
