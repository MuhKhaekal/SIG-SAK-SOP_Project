<x-app-layout>
    ...
    <div class="container mx-auto px-44 bg-white pt-10" data-aos="fade">
    ...
    @endif
        ...
        <div class="md:flex-1 mx-5" data-aos="fade-right">
            <div class="border-b border-gray-300">
                ...
                <div id="accordion1" class="accordion-content hidden" style="max-height: 0;">
                    <iframe src="{{ $school->link_maps }}" width="1170" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="mb-5"></iframe>
            ...
            <div class="border-b border-gray-300">
                ...
                <div id="accordion2" class="accordion-content hidden" style="max-height: 0;">
                    <iframe src="{{ $school->link_street_view }}" width="1170" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="mb-5"></iframe>
        ...
        @endforeach
            ...
            @else
                ...
                <p class="text-center italic text-gray-400">Belum ada Komentar Saat ini</p>
            @endif
            
        </div>
    
        <form action="{{ route('komentar.store') }}" method="POST" data-aos="fade-right">
            @csrf
            <label for="message" class="block mb-2 text-sm font-medium text-gray-900">Berikan Komentarmu : </label>
            <input type="hidden" name="school_id" value="{{ $school->id }}">
            <textarea id="message" name="comments" rows="4" class="block p-2.5 w-full text-sm text-gray-900 mb-5 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Tulis sesuatu disini ..."></textarea>
            <button type="submit" class="bg-blue-500 text-white px-3 py-2 rounded-md">Tambahkan Komentar</button>
        </form>
    </div>
